...
In the modeling phase of the project, I prepared features, split the data, and compared logistic regression, decision trees, k-NN, and Random Forest. Random Forest performed best on recall and balanced performance across classes. This Streamlit dashboard recreates the “Risk Factors by Age” figure with synthetic data.
